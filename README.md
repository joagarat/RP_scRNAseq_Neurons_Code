...
All single-cell RNA-seq and ATAC-seq datasets analyzed in this study are publicly available.
...
- Zu et al. (2023) – GEO dataset (GSE246791)
...
- Zu et al. (2023) ATACseq Dataset logCPM count matrix. sa2_logCPM_gmat.h5ad
- Zu et al. (2023) ATACseq Metadata. SI Table 2 Metadata table for all the 2.3 million nuclei in the snATAC-seq data.txt
